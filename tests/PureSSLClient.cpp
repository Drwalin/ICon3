...
public:
	...
	const tcp::resolver::results_type& endpoints) : socket_(io_context, context) {
	...
	void receive_response(std::size_t length) {
		boost::system::error_code err;
		size_t _length = socket_.read_some(boost::asio::buffer(reply_, length),
		err);
		if(!err) {
			std::cout << "Reply: ";
			std::cout.write(reply_, _length);
			std::cout << "\n";
		} else {
